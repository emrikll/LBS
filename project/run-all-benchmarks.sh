...
./run-benchmark.sh ./c_prototypes/print-50 200 ./print test
./run-benchmark.sh ./c_prototypes/print-100 200 ./print test
./run-benchmark.sh ./c_prototypes/print-200 200 ./print test
./run-benchmark.sh ./c_prototypes/print-500 200 ./print test
